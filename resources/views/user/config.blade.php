  ...
  <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">Configuración de mi cuentta</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="surnname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value={{ Auth::user()->surname }} required autocomplete="surnname" autofocus>
